...
- (NSPersistentContainer *)persistentContainer {
    ...
    @synchronized (self) {
        if (_persistentContainer == nil) {
            _persistentContainer = [[NSPersistentContainer alloc] initWithName:@"Scores"];
...
-(NSPersistentStoreCoordinator *) persistentStoreCoordinator {
    ...
    NSURL *managerUrl = [[[NSFileManager defaultManager] URLsForDirectory:NSDocumentDirectory inDomains:NSUserDomainMask] lastObject];
    NSURL *storeUrl = [managerUrl URLByAppendingPathComponent:@"Scores.sqlite"];
